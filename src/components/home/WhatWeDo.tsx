    ...
    <section className="pt-16 pb-36">
      <div className="holder">
        <div className="relative">
          ...
          <div className="w-full md:w-[55%] aspect-square absolute top-0 p-[5%] pb-[30%] md:pb-[5%] flex flex-col items-center justify-center gap-4 sm:gap-8  bg-cover text-white rounded-3xl" style={{background: `url('/vite.svg'), linear-gradient(to bottom left, rgba(0, 204, 0, .90), rgba(43, 152, 255, .95))`}}>
          ...
          {/* Right */}
          <div className="w-full md:w-[55%] aspect-square"></div>
          <div className="md:w-[55%] aspect-square absolute top-2/4 -translate-y-1/4  right-0 p-[7.5%] flex flex-col gap-4 sm:gap-8 bg-white rounded-3xl shadow-2xl">
